...
draft = false
title = '告别盲选LLM！ICML 2025新研究解释大模型选择的「玄学」'
+++

摘要：弗吉尼亚理工大学提出的LensLLM框架能够精准预测大语言模型微调性能，降低计算成本，解决了LLM选型的困境。该框架基于PAC - 贝叶斯泛化界限揭示微调动力学，运用NTK技术实现对模型性能的准确预测和高效选择，为大模型选择提供新的透视和方法。

主题标签：人工智能、模型选择、计算机科学
